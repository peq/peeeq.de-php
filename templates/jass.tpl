{if $html_code}
	...
	{else}
		{if $smarty.get.f}
			{if !$smarty.get.bb}
				<br /><a href="jass.php?id={$id}&amp;f=1&amp;bb=1">Diesen Code als BB-Code anzeigen</a>
			{else}
				<br /><a href="jass.php?id={$id}&amp;f=1">Diesen Code normal anzeigen</a>
			{/if}
			<br /><a href="jass.php?id={$id}">Diesen Code in Original-Formatierung anzeigen</a>
		{else}
			{if !$smarty.get.bb}
				<br /><a href="jass.php?id={$id}&amp;bb=1">Diesen Code als BB-Code anzeigen</a>
			{else}
				<br /><a href="jass.php?id={$id}">Diesen Code normal anzeigen</a>
			{/if}
	...
	<textarea rows="35" cols="80" id="copyarea" style="visibility:hidden;font-family:monospace;Corier New,Verdana,Tahoma,Arial;font-size:13px;color:#000000; background-color:#FFFFFF; margin-top:0px; margin-bottom:0px; border:1px solid #999999;white-space: nowrap; width: 97%;overflow:auto; height:500px;">{$jass_code}</textarea>
{else}
